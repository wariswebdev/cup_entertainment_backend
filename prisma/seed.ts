...
const movies = [
  ...
  },
  {
    ...
    posterUrl: "https://m.media-amazon.com/images/M/MV5BYTYxNGMyZTYtMjE3MS00MzNjLWFjNjYtMmM3ZTgzOGVlOTU0XkEyXkFqcGdeQXVyNjY5NDU4NzI@._V1_.jpg",
  ...
  {
    title: "The Departed",
    description: "An undercover cop and a police informant play a cat and mouse game with each other as they attempt to expose one another in the Boston underworld.",
...
async function main() {
  ...
  console.log(`✅ Successfully seeded ${movies.length} movies to the database!`);
}
